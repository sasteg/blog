...
![git log before the split](/images/lg_before_split.png)
...
![git rebase first screen 2](/images/rebase_first_screen2.png)
...
![git rebase second screen](/images/rebase_second_screen.png)
...
![git rebase stopped](/images/rebase_stopped_lg.png)
...
![git reset status](/images/rebase_reset_status.png)
...
![git rebase diff](/images/rebase_git_diff.png)

If we look at the log again at this point we see that the `f3` is gone though.

![git reset lg](/images/rebase_reset_lg.png)
...
![git log after the split](/images/rebase_after_split_lg.png)
...
![git rebase success](/images/rebase_success.png)
...
![git cherry-üick](/images/rebase_cherry-pick.png)

We now have the `f3a` commit sitting on top of latest master. Exactly what we wanted!  
![git final history](/images/rebase_final_history.png)
